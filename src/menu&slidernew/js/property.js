...
;(function($){
			 ...
			 if(markers.length){
				 for(var i = 0; i < markers.length ; i ++){
					...
					google.maps.event.addListener(gmarker, 'click', function(e) {
						 var infoContent = '<div class="gmap-infobox">\
								<div class="property-item-map-wrap">\
									<a class="info-close" onclick="return infoBox.close();" href="javascript:void(0)"><img src="https://www.google.com/intl/en_us/mapfiles/close.gif" align="right" /></a>\
									<div class="property-item-map">\
										<div class="thumbnail">\
											<a target="_blank" href="' + this.url + '" title="' + this.title + '">\
												<img src="' + this.image + '" alt="' + this.title + '" />\
											</a>\
										</div>\
										<div class="content">\
											<h4 class="content-title">\
												<a target="_blank" href="' + this.url + '" title="' + this.title + '">' + this.title + '</a>\
											</h4>\
											<div class="info">\
												<span class="area"><i class="icon-ruler"></i>' + this.area + '</span>\
												<span class="bed"><i class="icon-bed"></i>' + this.bedrooms + '</span>\
												<span class="bath"><i class="icon-bath"></i>' + this.bathrooms + '</span>\
												<span class="storage"><i class="icon-storage"></i>' + this.storage + '</span>\
											</div>\
											<div class="action">\
												<div class="price">\
													<span class="amount">560,000,000 تومان</span>\
												</div>\
												<a class="more" target="_blank" href="' + this.url + '" title="' + this.title + '">\
	...
	$(document).on('click','.gmap-full',function(e){
		...
		if($(this).closest('.noo-map').hasClass('fullscreen')){
			...
			$(this).empty().html('<i class="fa fa-expand"></i>تمام صفحه '+nooGmapL10n.fullscreen_label);
		}else{
			$(this).closest('.noo-map').addClass('fullscreen');
			$(this).empty().html('<i class="fa fa-compress"></i>خروج '+nooGmapL10n.default_label);
		}
